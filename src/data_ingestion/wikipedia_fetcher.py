...
class WikipediaFetcher(BaseFetcher):
    ...
    def fetch(self, page_title: str) -> Dict[str, Any]:
        ...
        result = {
            ...
            "categories": page.categories.keys() if page.categories else [],
    ...
    def _text_to_html(self, text: str, title: str) -> str:
        ...
        # Simple HTML wrapper for compatibility with existing parser
    ...
    def has_page_changed(self, page_title: str, stored_page_id: int) -> bool:
        ...
        Note: Wikipedia-API doesn't provide revision ID directly,
        so we use page ID. For more accurate change detection,
        you could store the text hash.
        """
        current_page_id = self.get_page_id(page_title)
        
        # Page IDs don't change, so we'll always fetch
        # You could enhance this by comparing text hashes
